...
---
💡 Recommendation
Prioritize retention campaigns on inactive customers in Germany — the highest-risk segment identified (41% churn)
Investigate the 3+ product segment — despite deeper relationships, these customers churn at 83–100%, suggesting forced bundling, unresolved complaints, or a struggling product tier rather than genuine loyalty
Use activity status as an early-warning signal — inactive members churn ~2x more than active ones across every country
